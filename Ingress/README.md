...
```
kubectl create deploy sample-1 --image=hashicorp/http-echo:0.2.3
kubectl create deploy sample-2 --image=hashicorp/http-echo:0.2.3
kubectl create deploy sample-3 --image=hashicorp/http-echo:0.2.3
kubectl create deploy sample-4 --image=hashicorp/http-echo:0.2.3
```
